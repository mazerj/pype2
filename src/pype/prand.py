...
class MTRandom:
    def __init__(self, seed=None, state=None):
        ...
        **seed** - single integer seed value

        **state** - length 624 SIGNED 2-byte integer vector that
        completely captures the state of the random number generator.
        Note that these are SIGNED values -- matlab expects UNSIGNED
        ...
        **MATLAB NOTE**
        To set the matlab random number generator to the same known
        state as the python generator, you need to convert the signed
        values of the seed into unsigned values as follows:
    ...
    def setstate(self, state):
        ...
        **state** -- 624 long vector of SIGNED ints
