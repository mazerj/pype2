...
/* EYETYPES.H has platform-portable definitions  */
...
#define SAMPLE_TYPE 200
     ...
     /*	This type can help in detecting event type
	or in allocating storage, but does not differentiate
	between integer and floating-point versions of data. */
